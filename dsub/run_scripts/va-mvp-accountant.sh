...
#RESULTS_ACCOUNT_DIR="/usr/local/results-accounting-20170628"
MAX_JOBS=1500
LOGFILE="accountant-jobs-170718.txt"
...
TAR_PGPS=$(gsutil -m ls gs://gbsc-gcp-project-mvp-received-from-bina/420902071/*tar.pgp)
